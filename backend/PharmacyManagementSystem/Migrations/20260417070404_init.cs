        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Manufactrer = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Medicines_MedicineCategory_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlternativeMedicineId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicineAlternative", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicineAlternative_Medicines_MedicineId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicineStocks_Pharmacies_PharmacyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_Medicines_MedicineId",
                        column: x => x.MedicineId,
                        principalTable: "Medicines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockWatchers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StockWatchers_Medicines_MedicineId",
                        column: x => x.MedicineId,
                        principalTable: "Medicines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockWatchers_Pharmacies_PharmacyId",
                        column: x => x.PharmacyId,
                        principalTable: "Pharmacies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicineAlternative_MedicineId",
                table: "MedicineAlternative",
                column: "MedicineId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicineStocks_PharmacyId_MedicineId",
                table: "MedicineStocks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_MedicineId",
                table: "Reservations",
                column: "MedicineId");

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_PatientId_Status",
                table: "Reservations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockWatchers_MedicineId",
                table: "StockWatchers",
                column: "MedicineId");

            migrationBuilder.CreateIndex(
                name: "IX_StockWatchers_PatientId_MedicineId_PharmacyId",
                table: "StockWatchers",
                columns: new[] { "PatientId", "MedicineId", "PharmacyId" },
                unique: true,
                filter: "[PharmacyId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_StockWatchers_PharmacyId",
                table: "StockWatchers",
                column: "PharmacyId");
        }
