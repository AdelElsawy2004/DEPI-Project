...
var t2 = { borderWidth: "0 1px 1px 1px", borderColor: "{content.border.color}", background: "{content.background}", color: "{text.color}", padding: "1.125rem" };
...
var d = { root: o, panel: r, header: e, content: t2, colorScheme: c };
...
var e7 = { gap: "0.5rem" };
var t5 = { fontSize: "1.25rem", fontWeight: "700" };
var a3 = { color: "{text.muted.color}" };
var d4 = { root: o9, body: r9, caption: e7, title: t5, subtitle: a3 };
...
var t8 = { borderColor: "{datatable.border.color}", padding: "0.75rem 1rem", sm: { padding: "0.375rem 0.5rem" }, lg: { padding: "1rem 1.25rem" } };
...
var k = { root: o18, header: r18, headerCell: e14, columnTitle: d7, row: l3, bodyCell: c7, footerCell: t8, columnFooter: a8, footer: n4, dropPoint: s3, columnResizer: i8, resizeIndicator: g, sortIcon: u, loadingIcon: b, rowToggleButton: p2, filter: f3, paginatorTop: h, paginatorBottom: m, colorScheme: v };
...
var a9 = { root: o19, header: r19, content: e15, footer: d8, paginatorTop: t9, paginatorBottom: n5, colorScheme: c8 };
...
var t10 = { hoverBackground: "{content.hover.background}", color: "{content.color}", hoverColor: "{content.hover.color}", padding: "0.375rem 0.625rem", borderRadius: "{content.border.radius}" };
...
var k2 = { root: o20, panel: r20, header: e16, title: d9, dropdown: c9, inputIcon: n6, selectMonth: t10, selectYear: a10, group: i9, dayView: l4, weekDay: f4, date: u2, monthView: s4, month: g2, yearView: h2, year: m2, buttonbar: b2, timePicker: p3, colorScheme: v2 };
...
var t12 = { background: "{content.background}", borderColor: "{content.border.color}", color: "{content.color}", borderRadius: "{content.border.radius}" };
var c10 = { light: { toolbar: { background: "{surface.50}" } }, dark: { toolbar: { background: "{surface.800}" } } };
var d13 = { toolbar: o25, toolbarItem: r25, overlay: e20, overlayOption: l7, content: t12, colorScheme: c10 };
...
var n8 = { root: o26, legend: r26, toggleIcon: e21, content: t13, colorScheme: c11 };
...
var i10 = { root: r27, header: o27, content: e22, file: a13, fileList: t14, progressbar: d14, basic: n9, colorScheme: c12 };
...
var l8 = { root: o29, navButton: r29, navIcon: e23, thumbnailsContent: t15, thumbnailNavButton: n10, thumbnailNavButtonIcon: a15, caption: c13, indicatorList: s5, indicatorButton: u3, insetIndicatorList: i12, insetIndicatorButton: d16, closeButton: g3, closeButtonIcon: f5, colorScheme: h3 };
...
var c14 = { root: o40, value: r39, range: t17, text: n13 };
...
var t18 = { color: "{list.option.color}", gutterStart: "-0.5rem", gutterEnd: "0.5rem" };
...
var n14 = { root: o41, list: r40, option: d21, optionGroup: i15, checkmark: t18, emptyMessage: e28, colorScheme: l10 };
...
var u4 = { root: o42, baseItem: n15, item: a18, overlay: i16, submenu: r41, submenuLabel: t19, submenuIcon: e29, separator: c15, mobileButton: d22, colorScheme: g4 };
...
var t21 = { borderRadius: "50%", size: "2rem", color: "{text.muted.color}", hoverColor: "{text.hover.muted.color}", hoverBackground: "{content.hover.background}", focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", color: "{focus.ring.color}", offset: "{focus.ring.offset}", shadow: "{focus.ring.shadow}" } };
var e30 = { light: { root: { background: "{surface.50}" } }, dark: { root: { background: "{surface.800}" } } };
var c16 = { root: o44, baseItem: r43, item: i18, submenu: n17, separator: a20, mobileButton: t21, colorScheme: e30 };
...
var n22 = { root: r50, header: o52, toggleableHeader: e36, title: d24, content: t27, footer: a25, colorScheme: c19 };
...
var t31 = { light: { handle: { background: "{surface.400}" } }, dark: { handle: { background: "{surface.600}" } } };
var c21 = { root: o67, gutter: r66, handle: n27, colorScheme: t31 };
...
var d30 = { root: o68, separator: r67, step: e43, stepHeader: t32, stepTitle: n28, stepNumber: a34, steppanels: c22, steppanel: i23 };
...
var c23 = { root: o69, separator: r68, itemLink: t33, itemLabel: e44, itemNumber: i24 };
...
var t34 = { borderWidth: "2px 0 0 0", borderColor: "transparent", hoverBorderColor: "transparent", activeBorderColor: "{primary.color}", color: "{text.muted.color}", hoverColor: "{text.color}", activeColor: "{primary.color}", padding: "1rem 1.25rem", fontWeight: "600", margin: "0", gap: "0.5rem", focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", color: "{focus.ring.color}", offset: "{focus.ring.offset}", shadow: "{focus.ring.shadow}" } };
...
var i25 = { root: o70, tablist: r69, item: t34, itemIcon: e45, activeBar: a35, colorScheme: c24 };
...
var t35 = { borderWidth: "2px 0 0 0", borderColor: "transparent", hoverBorderColor: "transparent", activeBorderColor: "{primary.color}", color: "{text.muted.color}", hoverColor: "{text.color}", activeColor: "{primary.color}", padding: "1rem 1.25rem", fontWeight: "700", margin: "0", gap: "0.5rem", focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", color: "{focus.ring.color}", offset: "{focus.ring.offset}", shadow: "inset {focus.ring.shadow}" } };
...
var s8 = { root: o71, tablist: r70, tab: t35, tabpanel: n29, navButton: c25, activeBar: e46, colorScheme: a36 };
...
var e47 = { root: o72, tabList: r71, tab: t36, tabPanel: n30, navButton: a37, colorScheme: c26 };
...
var c28 = { root: o76, list: i26, item: n31, submenu: a39, submenuIcon: t37, separator: r74 };
...
var a40 = { event: e49, horizontal: r75, vertical: n32, eventMarker: o77, eventConnector: t38 };
...
var d35 = { root: o83, node: r81, nodeIcon: e54, nodeToggleButton: t39, loadingIcon: c32, filter: n34 };
...
var C = { root: o85, header: r83, headerCell: e56, columnTitle: t40, row: c33, bodyCell: l17, footerCell: d37, columnFooter: n35, footer: a43, columnResizer: i29, resizeIndicator: s10, sortIcon: g5, loadingIcon: u7, nodeToggleButton: h4, paginatorTop: f10, paginatorBottom: b4, colorScheme: m3 };
...
var Qr = (Nr = ((r85, e59) => {
  ...
  return r85;
})({}, e5), e58(Nr, m4({ components: { accordion: d, autocomplete: a, avatar: n, badge: d3, blockui: o6, breadcrumb: t4, button: e6, datepicker: k2, card: d4, carousel: t6, cascadeselect: f2, checkbox: e9, chip: s2, colorpicker: d6, confirmdialog: r15, confirmpopup: a6, contextmenu: c6, dataview: a9, datatable: k, dialog: e17, divider: t11, dock: d11, drawer: e19, editor: d13, fieldset: n8, fileupload: i10, iftalabel: i13, floatlabel: d15, galleria: l8, iconfield: r30, image: i14, imagecompare: o33, inlinemessage: a17, inplace: n12, inputchips: f6, inputgroup: d18, inputnumber: d19, inputotp: e27, inputtext: d20, knob: c14, listbox: n14, megamenu: u4, menu: r42, menubar: c16, message: u5, metergroup: b3, multiselect: n19, orderlist: o48, organizationchart: n20, overlaybadge: t25, popover: e38, paginator: n21, password: n24, panel: n22, panelmenu: a26, picklist: o55, progressbar: t29, progressspinner: r56, radiobutton: e40, rating: i21, ripple: o61, scrollpanel: a29, select: n25, selectbutton: d27, skeleton: o65, slider: a32, speeddial: a33, splitter: c21, splitbutton: d29, stepper: d30, steps: c23, tabmenu: i25, tabs: s8, tabview: e47, textarea: d32, tieredmenu: c28, tag: a38, terminal: e48, timeline: a40, togglebutton: i27, toggleswitch: c30, tree: d35, treeselect: a42, treetable: C, toast: d33, toolbar: c31, tooltip: e53, virtualscroller: e57 } })));

// src/app/theme/app-theme.ts
var bluePrimaryPalette = Qr.primitive?.blue ?? {};
var NAVY_SURFACE_PALETTE = {
  0: "#ffffff",
  50: "#f3f7fd",
  100: "#e4ecf8",
  200: "#d0def0",
...
var APP_THEME_NAME = "Lara";
var APP_PRIMARY_COLOR = "blue";
var APP_SURFACE_COLOR = "navy";
var AppThemePreset = t(Qr, {
  semantic: {
...
//# sourceMappingURL=chunk-SNDVMDYD.js.map
