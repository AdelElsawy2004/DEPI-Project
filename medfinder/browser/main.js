...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-BLDOGQ2J.js").then((m) => m);
...
var appRoutes = [
  {
    path: "auth",
    loadChildren: () => import("./chunk-K3R75MTY.js").then((m) => m.default)
  },
  {
    path: "patient",
    loadChildren: () => import("./chunk-QFXCACFW.js").then((m) => m.default)
  },
  {
    path: "",
    loadChildren: () => import("./chunk-4AFJJEHI.js").then((m) => m.default)
  },
  {
    path: "**",
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppComponent, { className: "AppComponent", filePath: "app.component.ts", lineNumber: 10 });
})();
